        ...
        <View style={styles.container}>
            ...
            <View style={styles.btnWrapperIcon}>
                <TouchableOpacity style={[styles.btnSocial, { backgroundColor: '#4267B2' }]}>
                    <Image style={styles.btnImage1} source={require('../assets/img/icofacebook-19245101.png')} />
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btnSocial, { backgroundColor: '#0058d9' }]}>
                    <Image style={styles.btnImage2} source={require('../assets/img/icozalo.png')} />
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btnSocial, styles.btnBorder]}>
                    <Image style={styles.btnImage2} source={require('../assets/img/icogoogle1.png')} />
                </TouchableOpacity>
            </View>
        </View>
    )
